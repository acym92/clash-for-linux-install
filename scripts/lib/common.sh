...
CLASH_HA_CONFIG="${CLASH_RESOURCES_DIR}/ha.yaml"
CLASH_HA_STATE="${CLASH_RESOURCES_DIR}/ha-state.yaml"
CLASH_HA_CODEX_STATE="${CLASH_RESOURCES_DIR}/ha-codex-state.yaml"
CLASH_HA_SUB_UPDATE_STATE="${CLASH_RESOURCES_DIR}/ha-sub-update-state.yaml"
CLASH_HA_LOG="${CLASH_RESOURCES_DIR}/ha.log"
CLASH_HA_CLIENT_CONFIG="${CLASH_RESOURCES_DIR}/lan-client.yaml"
CLASH_HA_PID="${CLASH_RESOURCES_DIR}/ha.pid"
CLASH_HA_SUB_PID="${CLASH_RESOURCES_DIR}/ha-sub.pid"
CLASH_HA_SUB_TOKEN="${CLASH_RESOURCES_DIR}/ha-sub.token"
